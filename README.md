...
| P0 | As a owner | I want to modify my restaurant’s details at any time. | Upon clicking a restaurant post, retrieve the current restaurant's data via post ID and allow updates in MongoDB. |
